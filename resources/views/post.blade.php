<x-layout>
    ...
    <article class="py-8 max-w-screen-md">
        ...
        <div>
            ...
            in
            <a class="text-base text-gray-500 hover:underline" href="/categories/{{ $post->category->slug }}">{{ $post->category->name}}</a> | {{ $post->created_at->format('j F Y')}}
        </div>
                    ...
                    <address class="flex items-center my-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <!-- mengubah ke posts tapi query string nya kategori -->
