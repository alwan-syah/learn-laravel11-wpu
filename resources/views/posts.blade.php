<x-layout>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6">
        <div class="mx-auto max-w-screen-md sm:text-center">
            ...
            <form>
                <!-- jika ada request ke kategori dan yang dicari bukan sesuai kategori tidak muncul yg di cari tersebut -->
                @if(request('category'))
                <input type="hidden" name="category" value="{{request('category')}}">
                @endif
                <!-- jika ada request ke author dan yang dicari tidak ada di author tidak muncul yg di cari tersebut -->
                @if(request('author'))
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    ...
                    <!-- arah nya ke posts tapi mengirimkan kategori -->
                ...
                <div class="flex justify-between items-center">
                    ...
                    <!-- untuk mengarahkan ke posts dengan membawa author -->
            ...
            <!-- untuk menampilkan jika artikel tidak ditemukan -->
            @empty
            <div>
                <p class="font-semibold text-xl my-4">Article not found</p>
                <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Back to all post</a>
            </div>
            <!-- tag dibawah ini untuk menandakan akhir forelse -->
            @endforelse
